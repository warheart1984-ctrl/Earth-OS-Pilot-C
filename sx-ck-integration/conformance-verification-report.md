# Conformance Verification Report - SX-CK Integration EarthOS Pilot C
...
### 1. evidence-replay-verification (gov-evidence)
...
**Scores:**
- evidence-replay-verification: 100%
...
```json
{
  "receipt_id": "conf-verify-sxck-earthos-pilot-c-2026-07-17",
  "signer": "skill-conformance-suite-r1",
  "signature": "conformance-verification-signature",
  "hash": "sxck-earthos-pilot-c-conformance-verification-hash",
